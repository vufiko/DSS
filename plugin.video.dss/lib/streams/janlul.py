...
def addStreams():
    ...
    #if(xbmcutil.getResponse(janlul1)):
    #    color = 'green'
    #else :
    #    color = 'red'
    ...
    #if(xbmcutil.getResponse(janlul2)):
    #    color = 'green'
    #else :
    #    color = 'red'
    ...
    janlul3 = 'http://stream.ssh101.com/hls/janlul6.m3u8'
    if(xbmcutil.getResponse(janlul3)):
        color = 'green'
    else :
        color = 'red'
    xbmcutil.addMenuItem('[COLOR '+color+']JanLul.com - Stream 3[/COLOR]', janlul3, 'true', 'janlul', 'janlul')
    ...
    #janlul6 = 'http://stream.ssh101.com/hls/janlul6.m3u8'
    #if(xbmcutil.getResponse(janlul6)):
    #    color = 'green'
    #else :
    #    color = 'red'
    #xbmcutil.addMenuItem('[COLOR '+color+']JanLul.com - Stream 6[/COLOR]', janlul6, 'true', 'janlul', 'janlul')
